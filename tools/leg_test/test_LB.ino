// =============================================================
// LEFT BACK Leg Test — PCA9685 servo driver, ESP32
// Channels: Alpha=3, Beta=4, Gamma=5
// =============================================================
...
#define ALPHA_MIN    0
#define ALPHA_MAX  130   // 0=Inward, 130=Outward
#define ALPHA_MID   65

#define BETA_MIN     0
#define BETA_MAX   135   // 0=Front, 135=Back
#define BETA_MID    67
...
void printInfo() {
  Serial.println("--- LEFT BACK current state ---");
...
void doSweep() {
  Serial.println("=== LEFT BACK sweep ===");
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("=== LEFT BACK Leg Test ===");
  Serial.println("Channels: Alpha=3, Beta=4, Gamma=5");
