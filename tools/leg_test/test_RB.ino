// =============================================================
// RIGHT BACK Leg Test — PCA9685 servo driver, ESP32
// Channels: Alpha=9, Beta=10, Gamma=11
// =============================================================
...
void printInfo() {
  Serial.println("--- RIGHT BACK current state ---");
...
void doSweep() {
  Serial.println("=== RIGHT BACK sweep ===");
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("=== RIGHT BACK Leg Test ===");
  Serial.println("Channels: Alpha=9, Beta=10, Gamma=11");
